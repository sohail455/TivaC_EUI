    ...
    else
    {
        ...
        for(Local_Counter=0; Local_Counter<Copy_PinNum; Local_Counter++)
        {
            ...
            else
            {
                ...
                SET_BIT(GPIO_Arr[Copy_Config[Local_Counter].Port]->AFSEL,Copy_Config[Local_Counter].Pin);
                GPIO_Arr[Copy_Config[Local_Counter].Port]->PCTL&=(~(0b1111)<<(4*Copy_Config[Local_Counter].Pin));
                GPIO_Arr[Copy_Config[Local_Counter].Port]->PCTL|=(Copy_Config[Local_Counter].AltFuncNum)<<(4*Copy_Config[Local_Counter].Pin);
                break;
