...
void Speed (int speed_percentage_A , int speed_percentage_B)
{
    ...
    if ((speed_percentage_A == 1) && (speed_percentage_B == 1))
    {
        calculated_value_A = 2500-2;
        calculated_value_B = 2500-2;
    }
    else
    {
