...
void LCD_sendCommand(unsigned char command)
{
    ...
    Sys1_delay(1); /* delay for processing Tas = 50ns */
    GPIO_SetPinValue(LCD_E_PORT_ID,LCD_E_PIN_ID,GPIO_PIN_HIGH); /* Enable LCD E=1 */
    Sys1_delay(1); /* delay for processing Tpw - Tdws = 190ns */
    ...
    Sys1_delay(1); /* delay for processing Tdsw = 100ns */
    GPIO_SetPinValue(LCD_E_PORT_ID,LCD_E_PIN_ID,GPIO_PIN_LOW); /* Disable LCD E=0 */
    Sys1_delay(1); /* delay for processing Th = 13ns */
}
